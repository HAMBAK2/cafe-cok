...
public class CafePlanService {
    ...
    public CreatePlanDto createPlans(CreatePlanSearchCond searchCond) {
        ...
        if(inOperationHoursCafes.isEmpty()) {
            ...
            return CreatePlanDto.of(matchType, searchCond, convertCafeListToCafeDtoList(recommendCafes));
        }
        ...
        return CreatePlanDto.of(matchType, searchCond, convertCafeListToCafeDtoList(keywordFilteredCafes));
    }
